...
def login():
    ...
    if form.validate_on_submit():
        user = User_data.query.filter_by(email=form.email.data).first()
...
def signup(word=''):
    ...
    if form.validate_on_submit():
        new_user = User_data(firstname=form.firstname.data, lastname=form.lastname.data, email=form.email.data, location=form.location.data, language=form.language.data, password=form.password.data,)
